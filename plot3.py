...
def visualize_traffic_sign_examples_with_names():
    # Parameters
    ...
    for i in range(NUM_CATEGORIES):
        try:
            ...
            # Show class name (shortened if too long)
            class_name = classes.get(i, f"Unknown ({i})")
    ...
    plt.suptitle("Traffic Sign Examples", fontsize=16)
    plt.tight_layout()
    plt.subplots_adjust(top=0.95)
    plt.savefig('plots/traffic_sign_examples_with_names.png')
    plt.show()

    print("Traffic sign examples visualization saved to 'plots/traffic_sign_examples_with_names.png'")


# Run the visualization
visualize_traffic_sign_examples_with_names()